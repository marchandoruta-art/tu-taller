...
BEGIN
  ...
  LOOP
    ...
    -- Skip if missing essential vehicle data
    IF _plate IS NULL OR _brand IS NULL OR _model IS NULL THEN
      CONTINUE;
    END IF;
    ...
    VALUES (
      ...
      _owner_id, _apt.assigned_to, _apt.created_by, _org_id, 'recibido'
    )
