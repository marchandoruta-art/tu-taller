...
import { VehicleWithOwner, Profile, ROLE_LABELS, UserRole } from '@/lib/types';
import { Card, CardContent, CardHeader } from '@/components/ui/card';
import { VehicleStatusBadge } from './VehicleStatusBadge';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { Car, User, Clock, Wrench, Lock, UserCheck } from 'lucide-react';
...
export function VehicleCard({ vehicle, totalTime = 0 }: VehicleCardProps) {
